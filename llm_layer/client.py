...
Attempt order:
  1. Google Gemini (gemini-2.5-flash-latest) via google-genai SDK
...
# -- Provider constants -------------------------------------------------------
# gemini-2.5-flash-latest: current stable alias (google-genai SDK).
# Updated from gemini-2.5-flash which was deprecated for new users.
